    ...
    <div class="info-content">
      ...
      <section class="section">
        ...
        <ul class="detail">
          ...
          <li><span class="bold">营业时间</span> <span>{{info.workTiem}}</span></li>
        </ul>
      </section>
    </div>
  </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        supportClass: ['activity-orange', 'activity-green', 'activity-red']
      }
    },
    mounted() {
      // 如果数据还没有，调用方法
